...
public class LatLong {
  ...
  /**
   * This constructor automatically downcasts the latitude and longitude to floats, so that the
   * previous constructor can be used. It is added as a convenience method, since many of the GPS
   * methods return doubles.
   */
