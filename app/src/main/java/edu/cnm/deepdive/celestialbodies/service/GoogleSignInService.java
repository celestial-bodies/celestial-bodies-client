...
/**
 * This has been created to be a singleton. The methods in the instance of this class provide for
 * requesting email and id of the user of the app, setting the client and the account for google
 * sign in.
 */
